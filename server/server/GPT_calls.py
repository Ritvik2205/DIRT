...
def rate_answer(question, answer, language, occupation, setting):
...
response = rate_answer("Quel est votre arrêt? (What is your stop?)", "The city center", "French", "Bus Driver", "Bus Stop")
print(response)